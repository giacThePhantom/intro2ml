...
Si potrebbe anche preferire pesi di $0$ per features che non sono utili.
	...
	\subsection{Regolarizzatori comuni}
		...
		Si dice anche $2$-norm. Tipicamente si preferisce utilizzare:
		...
		Valori pi\`u piccoli di $p$ $<2$ incoraggiano vettori pi\`u sparsi, mentre valori pi\`u grandi scoraggiano pesi pi\`u grandi creando pertanto vettori con pesi pi\`u simili. Attenzione che con $p$ $<1$ la funzione diventa non convessa e quindi difficile da trattare.
